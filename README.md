...
| \*\*Botão CIMA (+)\*\* | Digital 5 | Navegação (Usa INPUT\_PULLUP) |

| \*\*Botão BAIXO (-)\*\* | Digital 6 | Navegação (Usa INPUT\_PULLUP) |

| \*\*Botão OK / Sair\*\* | Digital 7 | Confirmação e reset de alarme (Usa INPUT\_PULLUP) |
